...
def speech_to_text():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            return "Servis hatası. Lütfen internet bağlantınızı kontrol edin."
...
def predict_speaker():
    ...
    audio_data = recorded_audio.flatten()  # 1D array'e dönüştür
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.predict_button = QPushButton("Tahmin Modeli")
        self.predict_button.setFont(QFont("Georgia", 10))
        self.predict_button.setStyleSheet("background-color: #2E2E2E; color: white; padding: 10px; border-radius: 5px; border: 1px solid white;")
    ...
    def perform_prediction(self):
        self.text_display.append("<br><b>Tahmin Modeli:</b> Ses kaydı alınıyor ve işleniyor...")
        prediction = predict_speaker()
        self.text_display.append(f"Tahmin edilen kişi: {prediction}")
